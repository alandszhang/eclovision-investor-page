...
import { type Lang, type Bi, copy, customers, comparison, unitRanges, costCards } from './data/content'
  ...
  return <div className="min-h-screen bg-[#f7f9fc] text-[#142039]">
    ...
    <main>
      ...
      <PageSection id="overview" eyebrow={t.overview} title={t.overviewTitle} text={t.overviewText}>
        ...
        <div className="mt-16"><Subhead label={t.team} title={t.teamTitle}/><SlideVisual src="team.png" alt="EcloVision core team" caption={t.original}/></div>
      </PageSection>
